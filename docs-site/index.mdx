---
title: "NodalMerge"
description: "A local-first distributed state engine built around immutable operations — replayed deterministically into programmable projections."
---
...
[architecture/overview](/architecture/overview) for the full layer breakdown
and [architecture/projections](/architecture/projections) for why that
