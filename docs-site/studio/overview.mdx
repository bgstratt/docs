...
description: "Git for agent reasoning and execution — not Git for files. An agent-native collaborative development runtime built on NodalMerge."
---

# NodalMerge Studio

NodalMerge Studio is an agent-native collaborative development runtime built on
[NodalMerge](/). Humans, AI agents, automation, and MCP tools work together through
deterministic projections, coordinated task execution, and human review workflows — all
backed by a persistent, branchable, replayable artifact graph.
