...
{/* IMAGE: replay-debugging-cli-output.png — terminal output of `nodalmerge-server
    replay` showing resolved state and canonical hash for a captured pack, with a
    highlighted mismatch example if available. See docs-site/IMAGE_LIST.md. */}
