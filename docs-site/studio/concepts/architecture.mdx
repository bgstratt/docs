...
NodalMerge Studio exposes a frozen MCP v1 tool surface with 70 tools across 20
namespaces (`nm_v1_*`), 46 of which are dispatched in-process to autonomous agents.
