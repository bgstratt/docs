---
title: "NodalMerge"
description: "A local-first distributed state engine built around immutable operations, deterministic replay, and programmable projections."
---
...
<div class="nm-section-label">Real-world measurements</div>

<div class="nm-feature-row">
  <div class="nm-feature-item">
    <p class="nm-feature-title">294,521 ops/sec</p>
    <p class="nm-feature-desc">Native Rust core — real-world 259,778-edit editing trace, hash-linked DAG, per-character identity, policy checks all included.</p>
  </div>
  <div class="nm-feature-item">
    <p class="nm-feature-title">119,482 ops/sec</p>
    <p class="nm-feature-desc">Same engine, same trace, running in-browser via WASM — try it live in the <a href="https://nodalmerge.com/demos/bench-trace">Engine benchmark demo</a>.</p>
  </div>
  <div class="nm-feature-item">
    <p class="nm-feature-title">27,110 ops/sec</p>
    <p class="nm-feature-desc">Same browser run, with an Ed25519 signature on every operation — the integrity work most CRDT libraries skip entirely.</p>
  </div>
</div>

<p class="nm-section-desc">
  See <a href="/benchmarks/text-engine-performance">benchmarks/text-engine-performance</a> for methodology, environment, and how to read these numbers safely.
</p>

{/* ── HOW IT WORKS ──────────────────────────────────────────── */}

<div class="nm-section-label" style={{ marginTop: "3rem" }}>How it works</div>
...
Two primitives do all the work: **immutable operations** are what every peer
stores and exchanges, and **programmable projections** are what your product
reads. See [architecture/overview](/architecture/overview) for the full
layer breakdown and [architecture/projections](/architecture/projections)
for why that second primitive is the more underrated of the two.
