...
[Concepts → Multi-peer goal sourcing](/concepts/architecture#multi-peer-goal-sourcing).
...
See [Guides → Repository virtualization](/guides/repository-virtualization) for the
...
[Guides → Extending goals](/guides/extending-goals) for the full REST surface and
