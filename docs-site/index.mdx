...
<div class="nm-hero">
  ...
  <p class="nm-hero-subtitle">
    ...
    replication layer. NodalMerge is a replication engine built around
    deterministic history replay — write locally, merge concurrently, converge
    deterministically, with full audit-grade replay semantics.
  </p>
...
<div class="nm-section-label">Measured, not hand-waved</div>
...
<div class="nm-feature-row">
  ...
  <div class="nm-feature-item">
    <p class="nm-feature-title">~120,000 ops/sec</p>
  ...
  <div class="nm-feature-item">
    <p class="nm-feature-title">~27,000 ops/sec</p>
